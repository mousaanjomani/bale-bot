...
DEFAULTS = {
    ...
    "default_reply": "پیام شما دریافت شد ✅\nبرای نمایش منو /start را بزنید.",
    "wip_reply": "این بخش به‌زودی فعال می‌شود 🛠",
    "bot_enabled": True,
    # دکمه‌های سفارشی اضافه بر پروسه‌ها — از داشبورد قابل ویرایش است
    "menus": {
        "extra": [
            {"id": "other", "title": "🤲 درخواست یا سؤال دیگر",
             "reply": "درخواست خود را به صورت پیام بنویسید تا بررسی شود.", "wide": True},
        ],
    },
}

LOGO_PATH_BASE = "logo"  # stored as data/logo.<ext>
